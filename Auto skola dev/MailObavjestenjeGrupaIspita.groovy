...
def log = Logger.getLogger("com.acme.MailObavjestenjeGrupaIspita")
...
// Load HTML template
String fileContents = new File('C:/Program Files/Atlassian/Application Data/JIRA/scripts/Template/ObavjestenjeGrupaIspitTeorija.html').text 
