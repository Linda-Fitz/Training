...
visol = ComponentAccessor.getUserManager().getUserByKey("visol")
	...
	query = "issuetype = \"Kandidat\" and status = \"10303\" and cf[10814] = \"$issueKey\""
...
writer.write("""<p style="font-size: 50px; font-family: 'Satisfy', cursive;"><span style="color: #0000ff;"><a href="https://visoldev.ddns.net:8000/issues/?filter=11500">${issuesSize}</a></span></p>""")
