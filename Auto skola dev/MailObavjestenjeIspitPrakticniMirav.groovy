...
def log = Logger.getLogger("com.acme.MailObavjestenjeIspitPrakticniMirav")
...
// Load HTML template
String fileContents = new File('C:/Program Files/Atlassian/Application Data/JIRA/scripts/Template/ObavjestenjeIspitPrakticniMirav.html').text
...
String query = "issuetype = kandidat AND statusCategory = \"In Progress\""
...
for (i = kandidati.size() - 1; i >= 0; i--) {
	...
	if (kStatus != "10306" && kStatus != "10308" && kStatus != "10307" && kStatus != "10309" && kStatus != "10310" && kStatus != "10700") { continue } //Voznja-redovna obuka zavrsena, voznja- ispit prijavljen, voznja-nije polozio, voznja-dodatna obuka, voznja - dodatna obuka zavrsena, spreman za ispit
