...
def log = Logger.getLogger("com.acme.MailObavjestenjeTeorijaMirav")
...
// Load HTML template
String fileContents = new File('C:/Program Files/Atlassian/Application Data/JIRA/scripts/Template/ObavjestenjeTeorijaPromjenaMirav.html').text
