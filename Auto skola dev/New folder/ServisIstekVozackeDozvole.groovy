...
def log = Logger.getLogger("com.acme.MailIstekVozacke")
...
def datumVrijemeField = cfManager.getCustomFieldObject("customfield_10416")

GroovyShell shell = new GroovyShell()
def basePath = "C:/Program Files/Atlassian/Application Data/JIRA/scripts/helpers"
String query = "issuetype = zaposleni AND cf[10416] = startOfDay(5)"
...
String fileContents = new File('C:/Program Files/Atlassian/Application Data/JIRA/scripts/Template/ObavjestenjeIstekVozacke.html').text
...
sendEmail(email, "Obavje\u0161tenje o isteku vozacke dozvole", template.toString())
...
def bindTemplate(Issue issue) {
    def binding = [
        ...
        datum: nowFormatted,
        datumIstekaVozacka: datumIsteka,
