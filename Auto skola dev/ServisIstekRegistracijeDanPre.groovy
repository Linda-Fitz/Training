...
def datumVrijemeField = cfManager.getCustomFieldObject("customfield_10305")

GroovyShell shell = new GroovyShell()
def basePath = "C:/Program Files/Atlassian/Application Data/JIRA/scripts/helpers"
String query = "issuetype = vozila AND cf[10305] = startOfDay(1)"
...
String fileContents = new File('C:/Program Files/Atlassian/Application Data/JIRA/scripts/Template/ObavjestenjeIstekuRegistracije.html').text
...
sendEmail(email, "Obavje\u0161tenje o isteku registracije vozila", template.toString())
