...
def log = Logger.getLogger("com.acme.MailIstekUvjerenja")
...
def datumVrijemeField = cfManager.getCustomFieldObject("customfield_10417")

GroovyShell shell = new GroovyShell()
def basePath = "C:/Program Files/Atlassian/Application Data/JIRA/scripts/helpers"
String query = "issuetype = zaposleni AND cf[10417] = startOfDay(5)"
...
String fileContents = new File('C:/Program Files/Atlassian/Application Data/JIRA/scripts/Template/ObavjestenjeIstekLjekarskogZaposlenog.html').text
...
sendEmail(email, "Obavje\u0161tenje o isteku ljekarskog uvjerenja", template.toString())
...
def bindTemplate(Issue issue) {
    def binding = [
        ...
        datum: nowFormatted,
        datumIstekaLjekarskog: datumIsteka,
