...
def log = Logger.getLogger("com.acme.MailPotvrdaMailaMirav")
...
// Load HTML template
String fileContents = new File('C:/Program Files/Atlassian/Application Data/JIRA/scripts/Template/PotvrdaMailaMirav.html').text
